...
/**
 * TestGuessNumberGame:
 * This program is for testing in lab 5.
...
public class TestGuessNumberGame {
    public static void testPart1() {
        ...
        gng1.setMaxNum(5);
        gng1.setMaxTries(2);
        System.out.println("Min = " + gng1.getMinNum() + " Max = " + gng1.getMaxNum() + " Max tries = " + gng1.getMaxTries());
        gng1.playGame();
        
        // Not playing, just checking the getters
